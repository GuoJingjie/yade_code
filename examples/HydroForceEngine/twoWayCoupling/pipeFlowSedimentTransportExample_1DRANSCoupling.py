...
# 25/08/2021
#
# Same as sedimentTransportExample_1DRANSCoupling but for a pipe flow
# 
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# TO BE TESTED. NOT WORKING PROPERLY FOR NOW (in particular ilm = 6 is an attempt)
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#
...
waterDepth = 27.5	#Water depth, in diameter
...
slope = 0.0	#Inclination angle of the channel slope in radian
...
ndimz = 100	#Number of cells in the height
...
topPlane = box(center= (length/2.0, width/2.0,groundPosition+fluidHeight),extents=(2000,width/2.0,0),fixed=True,wire=False,color = (0,0,1),material = 'Mat')
O.bodies.append([lowPlane,topPlane]) #add to simulation
...
dpdxScale = densFluidPY*9.81*0.1
print(dpdxScale)

#########################
#### SIMULATION LOOP#####
#########################
HydroForceEngine/validations/fluidValidation/figProfiLog.png
O.engines = [
	# Reset the forces
	ForceResetter(),
