...
stokesRange = np.logspace(0,3,100) #Stokes range explored for the collisions created. The length of stokes range correspond to the number of collisions that will be modeled. 
