...
### MATERIAL ###
################
O.materials.append(CohFrictMat(young=E, poisson=0.3, density=2650, frictionAngle=radians(phi), normalCohesion=3e100,
                               shearCohesion=3e100, momentRotationLaw=True, label='gridNodeMat'))  # material to create the gridConnections
...
nodesIds, cylIds, pfIds = gmshPFacet(meshfile='sphere.mesh', shift=Vector3(xpafet, ypafet, 0.), orientation=oriBody, radius=r,
                                     wire=False, fixed=False, materialNodes='gridNodeMat', material='pFacetMat', color=[1, 0, 0])
