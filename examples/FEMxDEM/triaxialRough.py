...
Nbc = whereZero(bx[0]) * [-confining, 0, 0] + whereZero(bx[0] - sup(bx[0])) * [confining, 0, 0] + \
    whereZero(bx[1]) * [0, -confining, 0] + whereZero(bx[1] - sup(bx[1])) * [0, confining, 0]
