...
Dbc = whereZero(x[0]) * [1, 0] + whereZero(x[0] - sup(x[0])) * [1, 0] + whereZero(x[1] - inf(x[1])) * \
    [1, 1] + whereZero(x[1] - sup(x[1])) * whereNonPositive(x[0] - B) * [1, 1]
Vbc = whereZero(x[0]) * [0, 0] + whereZero(x[0] - sup(x[0])) * [0, 0] + whereZero(x[1] - inf(x[1])) * \
    [0, 0] + whereZero(x[1] - sup(x[1])) * whereNonPositive(x[0] - B) * [0, vel]
