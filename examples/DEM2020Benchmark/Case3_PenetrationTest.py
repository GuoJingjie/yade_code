...
# a bit pointless to download again with different N but it's to avoid collisions between parallel jobs
...
sp[-1] = sphere(sp[-1].state.pos, sp[-1].shape.radius, material='Steel')
O.bodies.append(sp)
...
O.engines = [
    ...
    InteractionLoop(
        ...
        [Ip2_FrictMat_FrictMat_MindlinPhys(
            ...
            en=MatchMaker(matches=((1, 1, e_gg), (0, 1, e_gs), (0, 0, e_ss)))
        )],
