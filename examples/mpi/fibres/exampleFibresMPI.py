...
# materials as usual.
young = 2e5
O.materials.append(CohFrictMat(young=young, poisson=0.3, density=1050, frictionAngle=radians(
    20), normalCohesion=1e100, shearCohesion=1e100, momentRotationLaw=True, label='spheremat'))
...
O.materials.append(CohFrictMat(young=young, poisson=0.3, density=5000, frictionAngle=radians(
    30), normalCohesion=1e100, shearCohesion=1e100, momentRotationLaw=True, label='facetnode'))
