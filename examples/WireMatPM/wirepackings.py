...
# packing 3
[netpack, lx, ly] = hexaNet(radius=radius, cornerCoord=[0, -0.4, 0], xLength=Lx, yLength=Ly +
                            0.05, mos=mos, a=a, b=b, startAtCorner=True, isSymmetric=True, **kw)
O.bodies.append(netpack)
print('Packing 3:')
print('Real net length in x-direction [m]: ', lx)
print('Real net length in y-direction [m]: ', ly)
...
# packing 4
[netpack, lx, ly] = hexaNet(radius=radius, cornerCoord=[0.4, -0.4, 0], xLength=Lx, yLength=Ly +
                            0.05, mos=mos, a=a, b=b, startAtCorner=True, isSymmetric=False, **kw)
O.bodies.append(netpack)
print('Packing 4:')
print('Real net length in x-direction [m]: ', lx)
print('Real net length in y-direction [m]: ', ly)
...
# packing 3
[netpack, lx, ly] = hexaNet(radius=radius, cornerCoord=[1, -0.4, 0], xLength=Lx, yLength=Ly +
                            0.05, mos=mos, a=a, b=b, startAtCorner=False, isSymmetric=True, **kw)
O.bodies.append(netpack)
print('Packing 3:')
print('Real net length in x-direction [m]: ', lx)
print('Real net length in y-direction [m]: ', ly)
...
# packing 4
[netpack, lx, ly] = hexaNet(radius=radius, cornerCoord=[1.4, -0.4, 0], xLength=Lx, yLength=Ly +
                            0.05, mos=mos, a=a, b=b, startAtCorner=False, isSymmetric=False, **kw)
O.bodies.append(netpack)
print('Packing 4:')
print('Real net length in x-direction [m]: ', lx)
print('Real net length in y-direction [m]: ', ly)
