...
MatCDM=O.materials.append(FrictMatCDM(young=young,density=density,poisson=poisson,frictionAngle=np.arctan(0.1),sigmaMax=sigmaMax, alpha=alpha,  c1=0.0, c2=0.0) )
...
O.engines=[
        ...
        InteractionLoop(
        GeomFunctorList,
        [Ip2_FrictMatCDM_FrictMatCDM_MindlinPhysCDM(), Ip2_FrictMat_FrictMatCDM_MindlinPhysCDM(), Ip2_FrictMat_FrictMat_MindlinPhys()],
        [Law2_ScGeom_MindlinPhysCDM_HertzMindlinCDM(label="lawHMCDM"),Law2_ScGeom_MindlinPhys_Mindlin(label="lawHM")]
        ),
