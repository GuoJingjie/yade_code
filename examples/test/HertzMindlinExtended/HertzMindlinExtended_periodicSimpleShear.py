...
O.engines=[
   ...
   InteractionLoop(
      ...
      GeomFunctorList,
      [Ip2_FrictMatCDM_FrictMatCDM_MindlinPhysCDM(), Ip2_FrictMat_FrictMatCDM_MindlinPhysCDM(), Ip2_FrictMat_FrictMat_MindlinPhys()],	[Law2_ScGeom_MindlinPhysCDM_HertzMindlinCDM(label="lawHMCDM"),Law2_ScGeom_MindlinPhys_Mindlin(label="lawHM")]
   ),
...
def addData():
   ...
   plot.addData(exz=O.cell.trsf[0,2],szz=stress[2,2],sxz=stress[0,2],tanPhi=stress[0,2]/stress[2,2],i=O.iter, averageContactRadius=Rmean/float(count), PercentYieldCont=yieldCont*100, averageMu=muMean/float(count))
