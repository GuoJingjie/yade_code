...
O.materials.append(CohFrictMat(young=15e6, poisson=0.4, density=2600, frictionAngle=radians(
    30), normalCohesion=1e6, shearCohesion=1e6, momentRotationLaw=True, etaRoll=0.1, label='spheres'))
...
O.engines = [
    ...
    InteractionLoop(
        ...
        [Law2_ScGeom_FrictPhys_CundallStrack(), Law2_ScGeom6D_CohFrictPhys_CohesionMoment(
            ...
            # if we want "rolling" friction even if the contact is not cohesive (or cohesion is broken), we will have to turn this true somewhere
