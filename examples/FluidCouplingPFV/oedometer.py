...
def history():
    plot.addData(e22=-triax.strain[1] - zeroe22, e22_theory=drye22 + (1 - dryFraction) * consolidation((O.time - zeroTime) * Cv /
                                                                                                       wetHeight**2) * 1000. / modulus, t=O.time, p=flow.getPorePressure((0.5, 0.1, 0.5)), s22=-triax.stress(3)[1] - 10000)
