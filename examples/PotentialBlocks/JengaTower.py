...
for i in range(0, 18):  # 18 layers
    for j in range(0, 3):  # 3 pieces per layer
        ...
        b.shape = PotentialBlock(r=r, R=0.0, a=[1, -1, 0, 0, 0, 0], b=[0, 0, 1, -1, 0, 0], c=[0, 0, 0, 0, 1, -1], d=[length / 2. - r + init, length / 2. - r + init,
                                                                                                                     width / 2. - r + init, width / 2. - r + init, height / 2. - r + init, height / 2. - r + init], isBoundary=False, color=color, AabbMinMax=True, fixedNormal=False)
...
bbb = Body()
bbb.shape = PotentialBlock(r=r, R=0.0, a=[1, -1, 0, 0, 0, 0], b=[0, 0, 1, -1, 0, 0], c=[0, 0, 0, 0, 1, -1], d=[width / 2. - r, width / 2. - r, width / 2. - r, width / 2. - r,
                                                                                                               thickness / 2. - r, thickness / 2. - r], id=len(O.bodies), isBoundary=True, color=[0, 0.5, 1], AabbMinMax=True, wire=False, fixedNormal=True, boundaryNormal=[0, 0, 1])
