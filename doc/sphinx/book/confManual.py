...
moduleMap = {'yade._packPredicates': 'yade.pack', 'yade._packSpheres': 'yade.pack', 'yade._packObb': 'yade.pack'}
...
latex_documents = [
        ('index-toctree-manuals', 'YadeManuals.tex', u'Using and Programming', u'Václav Šmilauer et al.', 'manual'),
]
