...
class TestLoop(unittest.TestCase):
    ...
    def testEnginesModificationInsideLoop(self):
        ...
        O.engines = [
            # change engines here
            PyRunner(initRun=True, iterPeriod=1, command='from yade import *; O.engines=[ForceResetter(),GravityEngine(),NewtonIntegrator()]'),
        ...
        O.step()
        O.step()  # run the 2nd ForceResetter, and epilogue
        self.assert_(O.subStep == -1)
