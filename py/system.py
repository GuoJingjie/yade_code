    ...
    for oldName in list(_deprecated.keys()):
        class warnWrap(object):
            ...
            def __call__(self, *args, **kw):
                import warnings
                warnings.warn("Class `%s' was renamed to (or replaced by) `%s', update your code! (you can run 'yade --update script.py' to do that automatically)" %
                              (self.old, self.new), DeprecationWarning, stacklevel=2)
