...
maskTest = [
    [0b00, "bb br gg gr rr"], [0b01, "bb br gr"], [0b10, "br gg gr"], [0b11, "br gr"]
]
# mask values, "colors"
...
for mask in maskTest:
    ...
    if(css != maskRes):
        ...
        raise YadeCheckError("collider.avoidSelfInteractionMask failed for " + str(maskValue) +
                             " should be: " + str(maskRes) + ", but the result is: " + str(css))
