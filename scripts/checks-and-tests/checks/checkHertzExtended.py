...
MatCDM=O.materials.append(FrictMatCDM(young=young,density=3000,poisson=poisson,frictionAngle=np.arctan(0.1),sigmaMax=sigmaMax, alpha=alpha,  c1=0.0, c2=0.0) )
