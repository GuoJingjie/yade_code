...
if ('CGAL' in features):
    ...
    y = 0.000000001
    z = 0.0000000005
    vertices = [[0 + x, 0 + y, 0 + z], [sizeB - x, 0 - y, 0 - z], [sizeB + x, sizeB + y, 0 - z], [sizeB + x, sizeB - y, sizeB + z],
                [0 - x, sizeB + y, 0 + z], [0 - x, sizeB - y, sizeB + z], [0 + x, 0 - y, sizeB - z], [sizeB - x, 0 + y, sizeB - z]]
